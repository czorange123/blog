...
如下图所示
![](/images/hexo-build/hexo-build-new_a_repository.png)

点击`New repository`后会出现
![](/images/hexo-build/hexo-build-creating_repository.png)
...
![](/images/hexo-build/hexo-build-clone_repository.png)
...
提交上去后github上项目是这样的
![](/images/hexo-build/hexo-build-gitpush.png)
...
1. 修改root配置
![](/images/hexo-build/hexo-build-update_config.png)

1. 修改deploy配置
![](/images/hexo-build/hexo-build-deploy_gh-pages.png)
...
![](/images/hexo-build/hexo-build-github_settings.png)

往下滚动找到`GitHub Pages`
![](/images/hexo-build/hexo-build-gh-pages.png)

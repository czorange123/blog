...
![最初的样式!](/images/vue-transition/vue-transition-before1.gif)
不知细心的你有没有发现什么问题？
...
![折衷的解决方案的样式!](/images/vue-transition/vue-transition-before2.gif)
...
![完美的解决方案的样式!](/images/vue-transition/vue-transition-before3.gif)
...
实现效果图
![手风琴模式!](/images/vue-transition/vue-transition-after.gif)
